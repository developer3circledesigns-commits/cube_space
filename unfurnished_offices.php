...
<head>
    ...
    <title>Unfurnished Office Spaces - CubeSpace</title>
    <meta name="description" content="Browse unfurnished office spaces in Chennai. Shell offices and bare spaces for custom fit-outs across prime business locations.">
...
<body>
    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent px-0 mb-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Unfurnished Office Spaces</li>
            </ol>
        </nav>

        <!-- Header -->
        <div class="mb-4">
            <h1 class="fw-bold mb-2">Unfurnished Office Spaces in <span id="pageCity" class="text-primary">Chennai</span></h1>
            <p class="text-muted mb-0">Shell offices and bare spaces ready for custom fit-outs across prime business locations.</p>
        </div>
        ...
        <div class="row g-4 content-area">
            ...
            <div class="col-lg-8">
                <div class="results-counter" id="resultsCounter">
                    <span>Showing <strong id="resultRange">1–<?= (int)min(20, $totalCount) ?></strong> of <strong id="resultCount"><?= (int)$totalCount ?></strong> Unfurnished Office Spaces</span>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body">
                    ...
                    <form id="callbackForm" onsubmit="handleCallbackForm(event)">
                        <input type="hidden" name="interest" value="unfurnished">
                        <input type="hidden" name="source" value="callback_unfurnished">
                        <div class="mb-3">
    ...
    <script>
        ...
        function renderCards(offices, container) {
            ...
            offices.forEach((o) => {
                ...
                const cardInner = `
                            <div class="card office-card flex-lg-row profile-card border-0" style="border:none; box-shadow:none;">
    ...
    <span style="font-weight:normal; text-transform:none;">(Negotiable)</span>
        ...
        function renderNearest(nearest) {
            ...
            nearest.forEach(o => {
                ...
                const nearestCardInner = `
                                    <div class="card office-card profile-card border-0" style="border:none; box-shadow:none;">
        ...
        function doLoadListings() {
            ...
            const request = fetch(apiUrl('/api/unfurnished_offices_api.php?' + qs), { cache: 'no-store', credentials: 'same-origin', headers: { 'Pragma': 'no-cache', 'Cache-Control': 'no-cache' } }).then(r => r.json());
            ...
            request.then(data => {
                ...
                .catch(err => {
                    console.error('unfurnished_offices load error:', err);
                    container.innerHTML =
        ...
        function openGetPriceModal(officeId, listingCode, workspaceName, listingType) {
            ...
            if (interestEl) {
                var t = (listingType || 'unfurnished').toString().trim().toLowerCase();
        ...
        MultiSelectEnquiry.init({
            ...
            storageKey: 'cubespace_multi_select_unfurnished'
        });
        FilterPanelToggle.init({ storageKey: 'cubespace_filters_open_unfurnished' });
        loadListings();
    </script>

...
<head>
    ...
    <title>Managed Office Spaces - CubeSpace</title>
    <meta name="description" content="Browse managed office spaces in Chennai. Fully furnished, serviced offices with flexible lease terms from top providers across all major locations.">
    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent px-0 mb-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Managed Office Spaces</li>
            </ol>
        </nav>

        <!-- Header -->
        <div class="mb-4">
            <h1 class="fw-bold mb-2">Managed Furnished Office Spaces in <span id="pageCity" class="text-primary">Chennai</span></h1>
    ...
    <span style="font-weight:normal; text-transform:none;">(Negotiable)</span>
        ...
        document.querySelectorAll('.filter-select').forEach(el => {
            el.addEventListener('change', () => {
                if (el.id === 'filterProduct' && el.value === 'commercial') {
                    el.value = '';
                    navigateTo('furnished_offices.php');
                    return;
                }
                currentPage = 1;
